...
class WebpageClassificationModel(nn.Module):
    def __init__(self, embeddings, n_features=10, hidden_size=100, n_classes=4, dropout_prob=0.5):
...
def run(data):
    ...
    embeding_file_path = "/Users/beyzacevik/Downloads/glove.6B/glove.6B.{}d.txt".format(emb_size)
